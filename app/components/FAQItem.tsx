...
export default function FAQItem ({
  ...
  return (
    <div
      className="flex flex-col border-b border-border py-8 transition-all cursor-pointer"
    ...
    >
      <div className="grid grid-cols-[max-content,1fr] gap-x-4">
        ...
        <h4 className="text-xl my-auto">{question}</h4>
        {/* <div></div> */}
        <p className={`transition-all duration-300 text-xl text-text-secondary col-start-2 ${showAnswer ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
